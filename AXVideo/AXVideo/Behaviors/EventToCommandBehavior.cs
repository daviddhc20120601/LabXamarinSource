...
namespace AXVideo.Behaviors
{
    public class EventToCommandBehavior : BehaviorBase<View>
    {
        ...
        public static readonly BindableProperty EventArgsParameterPathProperty = BindableProperty.Create("EventArgsParameterPath", typeof(string), typeof(EventToCommandBehavior));
        ...
        void OnEvent(object sender, object eventArgs)
        {
            ...
            else if (!string.IsNullOrEmpty(EventArgsParameterPath))
            {
